...
<Steps>
    ...
    <Step title="Add optional resources">
        Optionally add additional scripts or other resources to the `test-skill` folder. For more information, see [Examples](/oss/javascript/deepagents/skills#examples).
    </Step>
</Steps>
