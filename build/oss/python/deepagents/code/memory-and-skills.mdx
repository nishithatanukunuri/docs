...
<Steps>
    ...
    <Step title="Add optional resources">
        Optionally add additional scripts or other resources to the `test-skill` folder. For more information, see [What are skills](/oss/python/deepagents/skills#what-are-skills).
    </Step>
</Steps>
